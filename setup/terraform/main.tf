...
data "aws_ssm_parameter" "eks_ami_release_version" {
  name = "/aws/service/eks/optimized-ami/${aws_eks_cluster.main.version}/amazon-linux-2023/x86_64/standard/recommended"
}
...
resource "aws_eks_node_group" "main" {
  ...
  release_version = jsondecode(data.aws_ssm_parameter.eks_ami_release_version.value).release_version
